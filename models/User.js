...
export default (sequelize, DataTypesLocal = DataTypes) => {
  const User = sequelize.define('tblUser', {
    ...
    Complaints: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 0, field: 'Complaints' },
    ...
    VerificationNonContacts: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 0, field: 'VerificationNonContacts' },
